...
{
    public class UCAlarmHintViewModel : BindableBase, IConfirmation, IInteractionRequestAware
    {
        ...
        public UCAlarmHintViewModel(MAlarmInfo m, List<Patrol> selectPolice, int type = 0)
        {
            Type = type;
